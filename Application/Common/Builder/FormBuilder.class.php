...
class FormBuilder extends CommonController {
    ...
    /**
     * 设置页面左导航
     * @param $active_nav 左导航
     * @return $this
     * @author jry <598821125@qq.com>
     */
   public function setActiveNav($active_nav) {
        $this->_active_nav=$active_nav;
        return $this;
    }
    ...
    public function display() {
        ...
        if($this->_active_nav) $this->assign('active_nav',  $this->_active_nav);
